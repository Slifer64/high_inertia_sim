...
arma::mat KinematicChain::getTaskPosition(const arma::vec &j_pos) const
{
...
arma::mat KinematicChain::getTaskQuat(const arma::vec &j_pos) const
{
  return rotm2quat(getTaskRotm(j_pos));
}

arma::mat KinematicChain::getTaskRotm(const arma::vec &j_pos) const
{
